...
$sql = "SELECT name, phonenumber, email FROM users WHERE id = '$customer_id' AND usertype = 'customer'";
                ...
                <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                    <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-8">
                        <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                            <h3 class="text-primary"><i class="fa fa-edit" aria-hidden="true"></i> Edit Customer</h3>
