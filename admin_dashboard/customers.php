        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    // Fetch users
                    $sql = "SELECT id, name, phonenumber, email, usertype FROM users WHERE usertype = 'customer'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<a href='edit_customer.php?id=" . $row["id"] . "' class='btn btn-primary btn-sm'>Edit</a> ";
